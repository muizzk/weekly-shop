    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="weeklyShopApp.category.home.createOrEditLabel">Create or edit a Category</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="ownerLabel" for="category-owner">
                    Owner
                  </Label>
                  <AvField id="category-owner" type="text" name="owner" />
                </AvGroup>
                <AvGroup>
                  <Label id="orderLabel" for="category-order">
                    Order
                  </Label>
                  <AvField
                    id="category-order"
